...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/estilos-2.css') }}">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
        ...
        <div class="container-fluid" id="inversion-1">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h1 class="text-center">Inversión social</h1>
                        <div class="container">
                        <p>En nuestra cooperativa, el crecimiento va de la mano con la solidaridad. 
                            Nos enorgullece contar con un alto índice de entrega por inversión social, 
                            destinando recursos a programas que generan impacto real en la educación.<br>
                            Creemos que el éxito se mide no solo en cifras, sino en el progreso de nuestra comunidad. Por eso, 
                            seguimos impulsando iniciativas que mejoran la calidad de vida y fortalecen el tejido social. ¡Juntos construimos un futuro más próspero!
                        
                        </p>
                        <p>
                            _______________________________ <br>
                            Amin Nazzer, Gerente Cootragal.
                        </p>
        ...
        <!-- Carousel -->
            <div id="carrusel-container" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-fondo active">
                <img src="/img/banner/3.png" alt="Inversión social 3" class="d-block w-100">
                </div>
                <div class="carousel-item">
                <img src="/img/banner/6.png" alt="Inversión social 4" class="d-block w-100">
                </div>
                <div class="carousel-item">
                <img src="/img/banner/7.png" alt="Inversión social 5" class="d-block w-100">
                </div>
            </div>
