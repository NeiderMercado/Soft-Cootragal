...
<button type="button" id="btn-view-task" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal_view_aforo">
        Visualizar
    </button>

    <!-- The Modal -->
    <div class="modal" id="Modal_view_aforo">
    <div class="modal-dialog">
        <div class="modal-content">

        <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Agregar actividad AFORO</h4>
