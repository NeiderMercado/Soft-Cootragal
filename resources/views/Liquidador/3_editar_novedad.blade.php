...
<h2 id="titulos">EDITAR O ACTUALIZA REVISIÓN/NOVEDAD</h2>
                ...
                @method("PUT")
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="form-int-placa" placeholder="" name="int-placa" value="{{ $novedad_camaras->interno}}" >
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="conductor" placeholder="Seleccionar" name="conductor" value="{{ $novedad_camaras->conductor}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="actividad" id="exampleFormControlTextarea1" value="{{ $novedad_camaras->actividad}}" rows="3" required>{{ $novedad_camaras->actividad}}</textarea>
                        </div>
