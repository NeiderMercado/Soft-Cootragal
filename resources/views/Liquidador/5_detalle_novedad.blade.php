...
<h2 id="titulos">DETALLE DE REVISIÓN/NOVEDAD</h2>
                ...
                @method("PUT")
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="actividad" id="exampleFormControlTextarea1" disabled value="{{ $novedad_camaras->actividad}}" rows="3" required>{{ $novedad_camaras->actividad}}</textarea>
                        </div>
